...
import numpy as np
import pint
from metrust.constants import dry_air_spec_heat_press, earth_gravity
...
def calc_ecape(
    ...
    # calculate cape
    dew_point_temperature = _compat_dewpoint_from_specific_humidity(pressure, temperature, specific_humidity)
