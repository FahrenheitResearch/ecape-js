...
from ecape_parcel_metrust.ecape_calc import calc_ecape_ncape, calc_sr_wind
...
def calc_ecape_parcel(
    ...
    if "user_defined" == cape_type:
        ...
        parcel_dewpoint = _compat_dewpoint_from_specific_humidity(parcel_pressure, parcel_temperature, avg_specific_humidity)
